...
def exportmysql(dataset):
    ...
    if list(product_dataset.shape)[1] == 20:
        try:
...
if __name__ == '__main__':
    ...
    for name in file_name:
        ...
        exportmysql (dataset)
    # 商品数据更新
    filelist, product_name = get_productfile (SourceDir)
    product_dataset = Merge_productfile(filelist, product_name,dt)
    exportmysql(product_dataset)
